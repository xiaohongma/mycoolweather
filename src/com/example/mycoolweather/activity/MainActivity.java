...
option.setEnableSimulateGps(false);//可选，默认false，设置是否需要过滤gps仿真结果，默认需要
	...
	/*protected void dialog() {
	 ...
	 builder.setMessage("您的颜值过高，可能影响天气获取！！！");
	builder.setTitle("颜值预警");
	builder.setPositiveButton("我认罪！", new android.content.DialogInterface.OnClickListener() {
   ...
   builder.setNegativeButton("我不服！", new android.content.DialogInterface.OnClickListener() {
	@Override
	  public void onClick(DialogInterface dialog, int which) {
       dialog.dismiss();
       finish();
